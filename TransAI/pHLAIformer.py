...
parser.add_argument('--cut_peptide', type = str, default = False, help = 'Whether to split peptides larger than cut_length?')
...
parser.add_argument('--output_heatmap', type = str, default = False, help = 'Visualize the mutual influence of peptide and HLA on the binding?')
parser.add_argument('--output_mutation', type = str, default = False, help = 'Whether to perform mutations with better affinity for each sample?')
...
# print("flag_output_mutation: ", args.output_mutation)
if args.output_mutation == "True":
