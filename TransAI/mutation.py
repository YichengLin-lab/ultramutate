...
def HLA_Length_position_keyaatype(aatype_position_pd, aatype_position_contrib_pd, length = 9):
    ...
    for posi in range(1, length + 1):
        ...
        position_contrib_keyaatype[posi] = [key_aatype, len(key_aatype), round(temp_sorted.max(), 2), round(temp_sorted.mean(), 2)]
    ...
    for posi in range(1, length + 1):
        ...
        position_keyaatype[posi] = [key_aatype, len(key_aatype), round(temp_sorted.max(), 2), round(temp_sorted.mean(), 2)]
